...
//
//        Assert.assertTrue(page.getMessage().contains(getEnvProperty("successAddedToCartMessage")), "Confirmation message is shown");
//        Assert.assertEquals(page.getProductName(), product.getName(), "Correct name is shown");
//        Assert.assertEquals(page.getProductPrice(), product.getPrice(), "Correct price is shown");
//    }
//
//
