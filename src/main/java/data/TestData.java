...
public class TestData {
    ...
    public static final String SIGNIN_PAGE_URL = HOME_PAGE_URL + "?controller=authentication";
    public static final String MY_ACCOUNT_PAGE = HOME_PAGE_URL + "?controller=my-account";
